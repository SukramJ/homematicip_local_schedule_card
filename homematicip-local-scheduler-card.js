...
const r = (t, ...e) => {
    ...
    : (t) =>
        t instanceof CSSStyleSheet
          ? ((t) => {
              ...
              return ((t) => new o("string" == typeof t ? t : t + "", void 0, s))(e);
            })(t)
          : t,
  {
    is: d,
  ...
  y = (t, e) => !d(t, e),
  $ = { attribute: !0, type: String, converter: m, reflect: !1, useDefault: !1, hasChanged: y };
...
let A = class extends HTMLElement {
  ...
  createRenderRoot() {
    ...
    return (
      ((t, s) => {
        if (i) t.adoptedStyleSheets = s.map((t) => (t instanceof CSSStyleSheet ? t : t.styleSheet));
        else
          for (const i of s) {
        ...
        n =
          "function" == typeof t.converter
            ...
            : void 0 !== t.converter?.fromAttribute
              ...
              : m;
      this._$Em = s;
      const o = n.fromAttribute(e, t.type);
  ...
  C(t, e, { useDefault: i, reflect: s, wrapped: n }, o) {
    (i &&
      ...
      (this._$Ej.set(t, o ?? e ?? this[t]), !0 !== n || void 0 !== o)) ||
...
const S = globalThis,
  b = S.trustedTypes,
  x = b ? b.createPolicy("lit-html", { createHTML: (t) => t }) : void 0,
  w = "$lit$",
  ...
  Y = (t, ...e) => ({ _$litType$: 1, strings: t, values: e }),
  W = Symbol.for("lit-noChange"),
  z = Symbol.for("lit-nothing"),
  j = new WeakMap(),
  B = I.createTreeWalker(I, 129);
function Z(t, e) {
            ...
            ? ">" === d[0]
              ...
              : void 0 === d[1]
                ...
                : ((l = r.lastIndex - d[2].length),
                  (a = d[1]),
                  (r = void 0 === d[3] ? F : '"' === d[3] ? P : H))
            : r === P || r === H
              ? (r = F)
              : r === k || r === M
                ? (r = R)
                : ((r = F), (n = void 0)));
    const h = r === F && t[e + 1].startsWith("/>") ? " " : "";
    o +=
      r === R
        ? i + N
        : l >= 0
          ? (s.push(a), i.slice(0, l) + w + i.slice(l) + D + h)
          : i + D + (-2 === l ? e : h);
  }
  return [Z(t, o + (t[i] || "<?>") + (2 === e ? "</svg>" : 3 === e ? "</math>" : "")), s];
};
class G {
  constructor({ strings: t, _$litType$: e }, i) {
    ...
    const r = t.length - 1,
      ...
      [d, l] = X(t, e);
    if (
      ((this.el = G.createElement(d, i)), (B.currentNode = this.el.content), 2 === e || 3 === e)
    ) {
      const t = this.el.content.firstChild;
      t.replaceWith(...t.childNodes);
    }
    for (; null !== (s = B.nextNode()) && a.length < r; ) {
      if (1 === s.nodeType) {
        if (s.hasAttributes())
          for (const t of s.getAttributeNames())
            if (t.endsWith(w)) {
              const e = l[o++],
                i = s.getAttribute(t).split(D),
                r = /([.?@])?(.*)/.exec(e);
              (a.push({
                type: 1,
                index: n,
                name: r[2],
                strings: i,
                ctor: "." === r[1] ? tt : "?" === r[1] ? et : "@" === r[1] ? it : Q,
              }),
                s.removeAttribute(t));
            } else t.startsWith(D) && (a.push({ type: 6, index: n }), s.removeAttribute(t));
        if (V.test(s.tagName)) {
          const t = s.textContent.split(D),
            e = t.length - 1;
          if (e > 0) {
            s.textContent = b ? b.emptyScript : "";
            for (let i = 0; i < e; i++)
              (s.append(t[i], C()), B.nextNode(), a.push({ type: 2, index: ++n }));
            s.append(t[e], C());
          }
        }
      } else if (8 === s.nodeType)
        if (s.data === T) a.push({ type: 2, index: n });
        else {
          let t = -1;
          for (; -1 !== (t = s.data.indexOf(D, t + 1)); )
            (a.push({ type: 7, index: n }), (t += D.length - 1));
        }
      n++;
    }
  }
...
let J = class {
  ...
  u(t) {
    const {
      ...
      s = (t?.creationScope ?? I).importNode(e, !0);
    B.currentNode = s;
    let n = B.nextNode(),
      o = 0,
      r = 0,
...
class q {
  ...
  $(t) {
    const { values: e, _$litType$: i } = t,
      s =
        "number" == typeof i
          ? this._$AC(t)
          : (void 0 === i.el && (i.el = G.createElement(Z(i.h, i.h[0]), this.options)), i);
    if (this._$AH?._$AD === s) this._$AH.p(e);
    else {
      const t = new J(s, this),
        i = t.u(this.options);
  ...
  k(t) {
    ...
    for (const n of t)
      (s === e.length
        ? e.push((i = new q(this.O(C()), this.O(C()), this, this.options)))
        : (i = e[s]),
        i._$AI(n),
        s++);
...
class Q {
  ...
  _$AI(t, e = this, i, s) {
    ...
    let o = !1;
    if (void 0 === n)
      ((t = K(this, t, e, 0)), (o = !O(t) || (t !== this._$AH && t !== W)), o && (this._$AH = t));
    else {
      const s = t;
      let r, a;
...
(ot?.(G, q), (S.litHtmlVersions ??= []).push("3.3.1"));
const rt = globalThis;
    ...
    (this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
      ...
      (this._$Do = ((t, e, i) => {
        ...
        if (void 0 === n) {
          ...
          s._$litPart$ = n = new q(e.insertBefore(C(), t), t, void 0, i ?? {});
        }
        return (n._$AI(t), n);
...
((at._$litElement$ = !0), (at.finalized = !0), rt.litElementHydrateSupport?.({ LitElement: at }));
const dt = rt.litElementPolyfillSupport;
(dt?.({ LitElement: at }), (rt.litElementVersions ??= []).push("4.2.1"));
...
function ut(t) {
  return ht({ ...t, state: !0, attribute: !1 });
}
class pt {
  constructor(t) {}
  get _$AU() {
...
const { I: _t } = nt,
  ...
  vt = (t, e, i) => {
    ...
    if (void 0 === i) {
      const e = s.insertBefore(gt(), n),
        o = s.insertBefore(gt(), n);
      i = new _t(e, o, t, t.options);
    } else {
      ...
      if (e !== n || r) {
        ...
        for (; t !== e; ) {
          const e = t.nextSibling;
          (s.insertBefore(t, n), (t = e));
        }
      }
    }
    return i;
  },
  Et = (t, e, i = t) => (t._$AI(e, i), t),
  ft = {},
  mt = (t) => {
    ...
    class extends pt {
      ...
      dt(t, e, i) {
        ...
        const n = [],
          o = [];
        let r = 0;
        for (const e of t) ((n[r] = s ? s(e, r) : r), (o[r] = i(e, r)), r++);
      ...
      update(t, [e, i, s]) {
        ...
        for (; h <= u && p <= _; )
          ...
          else if (a[h] === r[p]) ((d[p] = Et(n[h], o[p])), h++, p++);
          else if (a[u] === r[_]) ((d[_] = Et(n[u], o[_])), u--, _--);
          else if (a[h] === r[_]) ((d[_] = Et(n[h], o[_])), vt(t, d[_ + 1], n[h]), h++, _--);
          else if (a[u] === r[p]) ((d[p] = Et(n[u], o[p])), vt(t, n[h], n[u]), u--, p++);
          else if ((void 0 === l && ((l = yt(r, p, _)), (c = yt(a, h, u))), l.has(a[h])))
            if (l.has(a[u])) {
              const e = c.get(r[p]),
                i = void 0 !== e ? n[e] : null;
              if (null === i) {
                const e = vt(t, n[h]);
                (Et(e, o[p]), (d[p] = e));
              } else ((d[p] = Et(i, o[p])), vt(t, n[h], i), (n[e] = null));
              p++;
            } else (mt(n[u]), u--);
          else (mt(n[h]), h++);
        for (; p <= _; ) {
...
!(function (t) {
  ((t[(t.SUNDAY = 1)] = "SUNDAY"),
    (t[(t.MONDAY = 2)] = "MONDAY"),
    (t[(t.TUESDAY = 4)] = "TUESDAY"),
    (t[(t.WEDNESDAY = 8)] = "WEDNESDAY"),
    (t[(t.THURSDAY = 16)] = "THURSDAY"),
    (t[(t.FRIDAY = 32)] = "FRIDAY"),
    (t[(t.SATURDAY = 64)] = "SATURDAY"));
})(At || (At = {}));
const St = ["MONDAY", "TUESDAY", "WEDNESDAY", "THURSDAY", "FRIDAY", "SATURDAY", "SUNDAY"],
  bt = {
    SUNDAY: At.SUNDAY,
    MONDAY: At.MONDAY,
    TUESDAY: At.TUESDAY,
    WEDNESDAY: At.WEDNESDAY,
    THURSDAY: At.THURSDAY,
    FRIDAY: At.FRIDAY,
...
function Tt(t) {
  const e = [];
  for (const i of St) t.includes(bt[i]) && e.push(i);
  return e;
}
function Nt(t) {
  return Boolean(
    t.WEEKDAY && t.WEEKDAY.length > 0 && t.TARGET_CHANNELS && t.TARGET_CHANNELS.length > 0,
  );
}
function It(t, e) {
  return {
    ...e,
    groupNo: t,
    weekdayNames: Tt(e.WEEKDAY),
    timeString:
      ((i = e.FIXED_HOUR),
      (s = e.FIXED_MINUTE),
      `${i.toString().padStart(2, "0")}:${s.toString().padStart(2, "0")}`),
    isActive: Nt(e),
  };
  var i, s;
}
(!(function (t) {
  ...
  (function (t) {
    ((t[(t.FIXED_TIME = 0)] = "FIXED_TIME"), (t[(t.ASTRO = 1)] = "ASTRO"));
  })(wt || (wt = {})),
  (function (t) {
    ((t[(t.MS_100 = 0)] = "MS_100"),
      (t[(t.SEC_1 = 1)] = "SEC_1"),
...
const Ct = {
  en: {
    ...
    categories: { SWITCH: "Switch", LOCK: "Lock", LIGHT: "Light", COVER: "Cover", VALVE: "Valve" },
    ui: {
      schedule: "Schedule",
    ...
    warnings: { title: "Validation Warnings", noWarnings: "No issues detected" },
  },
  de: {
    weekdays: {
      short: {
...
let Ut = class extends at {
  ...
  setConfig(t) {
    ...
    if ((i(t.entity), Array.isArray(t.entities) && t.entities.forEach((t) => i(t)), 0 === e.length))
      throw new Error("You need to define at least one entity");
    e.sort((t, e) => t.localeCompare(e));
    const s = this._activeEntityId,
      n = e[0],
      o = s && e.includes(s) ? s : n;
    ((this._config = {
      editable: !0,
      hour_format: "24",
      ...
      (this._activeEntityId = o),
      (this._editingEvent = void 0),
      (this._editingGroupNo = void 0),
      (this._showEditor = !1),
      ...
      if (this.hass && e) {
        if (
          ((this.hass.language === e.language &&
            this.hass.locale?.language === e.locale?.language) ||
            this._updateLanguage(),
          this._activeEntityId)
        ) {
          const t = e.states?.[this._activeEntityId],
            i = this.hass.states?.[this._activeEntityId];
          t !== i && this._updateScheduleData();
        }
      } else this.hass && !e && this._updateScheduleData();
    }
    return (t.has("_activeEntityId") && this._updateScheduleData(), !0);
  }
  _updateScheduleData() {
    if (!this._activeEntityId || !this.hass?.states)
      return ((this._scheduleData = void 0), void (this._category = void 0));
    const t = this.hass.states[this._activeEntityId];
    if (!t) return ((this._scheduleData = void 0), void (this._category = void 0));
    const e = t.attributes;
    ((this._scheduleData = e.schedule_data), (this._category = e.datapoint_category));
  }
  _getEntityName(t) {
    const e = this.hass?.states?.[t];
    return e?.attributes?.friendly_name || t;
  }
  _handleEntityChange(t) {
    ((this._activeEntityId = t.target.value), this._closeEditor());
  }
  _handleAddEvent() {
    const t = (function (t) {
        const e = {
          ASTRO_OFFSET: 0,
          ASTRO_TYPE: xt.SUNRISE,
          CONDITION: wt.FIXED_TIME,
          FIXED_HOUR: 0,
          FIXED_MINUTE: 0,
          TARGET_CHANNELS: [],
          WEEKDAY: [],
        ...
        return (
          "COVER" === t
            ? ((e.LEVEL = 0), (e.LEVEL_2 = 0))
            : "SWITCH" === t
              ? ((e.DURATION_BASE = Dt.MS_100), (e.DURATION_FACTOR = 0), (e.LEVEL = 0))
              : "LIGHT" === t
                ? ((e.DURATION_BASE = Dt.MS_100),
                  (e.DURATION_FACTOR = 0),
      ...
      e = this._scheduleData ? Object.keys(this._scheduleData).map((t) => parseInt(t, 10)) : [],
      i = e.length > 0 ? Math.max(...e) : 0;
    ((this._editingGroupNo = i + 1), (this._editingEvent = { ...t }), (this._showEditor = !0));
  }
  _handleEditEvent(t) {
    ((this._editingGroupNo = t.groupNo), (this._editingEvent = { ...t }), (this._showEditor = !0));
  }
  _handleDeleteEvent(t) {
    if (!confirm(this._translations.ui.confirmDelete || "Delete this event?")) return;
    const e = { ...this._scheduleData };
    (delete e[t.groupNo.toString()], this._saveSchedule(e));
  }
  _closeEditor() {
    ((this._showEditor = !1), (this._editingEvent = void 0), (this._editingGroupNo = void 0));
  }
  _handleSaveEvent() {
    if (!this._editingEvent || void 0 === this._editingGroupNo) return;
    const t = (function (t, e) {
      const i = [];
      return (
        (t.FIXED_HOUR < 0 || t.FIXED_HOUR > 23) &&
          i.push({ field: "FIXED_HOUR", message: "Hour must be between 0 and 23" }),
        (t.FIXED_MINUTE < 0 || t.FIXED_MINUTE > 59) &&
          i.push({ field: "FIXED_MINUTE", message: "Minute must be between 0 and 59" }),
        t.CONDITION === wt.ASTRO &&
          (t.ASTRO_OFFSET < -120 || t.ASTRO_OFFSET > 120) &&
          i.push({
            field: "ASTRO_OFFSET",
        ...
        "SWITCH" === e || "LOCK" === e
          ? 0 !== t.LEVEL &&
            1 !== t.LEVEL &&
            i.push({ field: "LEVEL", message: "Level must be 0 or 1 for switch/lock" })
          : (t.LEVEL < 0 || t.LEVEL > 1) &&
            i.push({ field: "LEVEL", message: "Level must be between 0.0 and 1.0" }),
        "COVER" === e &&
          void 0 !== t.LEVEL_2 &&
          (t.LEVEL_2 < 0 || t.LEVEL_2 > 1) &&
          i.push({ field: "LEVEL_2", message: "Slat position must be between 0.0 and 1.0" }),
        (t.WEEKDAY && 0 !== t.WEEKDAY.length) ||
          i.push({ field: "WEEKDAY", message: "At least one weekday must be selected" }),
        (t.TARGET_CHANNELS && 0 !== t.TARGET_CHANNELS.length) ||
          i.push({
    ...
    })(this._editingEvent, this._category);
    if (t.length > 0)
      return void alert(
        `Validation errors:\n${t.map((t) => `- ${t.field}: ${t.message}`).join("\n")}`,
      );
    const e = { ...this._scheduleData, [this._editingGroupNo.toString()]: this._editingEvent };
    (this._saveSchedule(e), this._closeEditor());
  }
  async _saveSchedule(t) {
    if (this._activeEntityId && this.hass) {
      ...
      try {
        ...
        (await this.hass.callService("homematicip_local", "set_schedule", {
          ...
          (this._scheduleData = t));
      } catch (t) {
        alert(`Failed to save schedule: ${t}`);
      } finally {
        this._isLoading = !1;
      }
    }
  }
  _updateEditingEvent(t) {
    this._editingEvent &&
      ((this._editingEvent = { ...this._editingEvent, ...t }), this.requestUpdate());
  }
  _groupEventsByWeekday() {
    const t = new Map();
    if (!this._scheduleData) return t;
    const e = (function (t) {
      const e = [];
      for (const [i, s] of Object.entries(t)) {
        const t = parseInt(i, 10);
        isNaN(t) || e.push(It(t, s));
      }
      return (
        e.sort((t, e) => 60 * t.FIXED_HOUR + t.FIXED_MINUTE - (60 * e.FIXED_HOUR + e.FIXED_MINUTE)),
        e
      );
    })(this._scheduleData);
    for (const i of e) for (const e of i.weekdayNames) (t.has(e) || t.set(e, []), t.get(e).push(i));
    return t;
  }
  ...
  _renderScheduleList() {
    if (!this._scheduleData) return Y`<div class="no-data">${this._translations.ui.loading}</div>`;
    const t = this._groupEventsByWeekday();
    return 0 === t.size
      ? Y`
        <div class="no-data">
          ...
          ${
            this._config?.editable
              ? Y`<button @click=${this._handleAddEvent} class="add-button">
            ...
            return i < 1e3
              ...
              : i < 6e4
                ...
                : i < 36e5
                  ? `${(i / 6e4).toFixed(1)}m`
                  : `${(i / 36e5).toFixed(1)}h`;
          })(t.DURATION_BASE, t.DURATION_FACTOR)
        : "-";
    return Y`
  ...
  _renderEditor() {
    if (!this._showEditor || !this._editingEvent) return Y``;
    const t = !this._scheduleData?.[this._editingGroupNo?.toString() || ""];
    return Y`
  ...
  _renderTimeFields() {
    ...
    const t = `${String(this._editingEvent.FIXED_HOUR).padStart(2, "0")}:${String(this._editingEvent.FIXED_MINUTE).padStart(2, "0")}`;
    return Y`
      <div class="form-group">
        ...
        <input
          ...
          @change=${(t) => {
            const e = (function (t) {
              const e = t.split(":");
              if (2 !== e.length) throw new Error(`Invalid time format: ${t}`);
              const i = parseInt(e[0], 10),
                s = parseInt(e[1], 10);
              if (isNaN(i) || isNaN(s) || i < 0 || i > 23 || s < 0 || s > 59)
                throw new Error(`Invalid time values: ${t}`);
              return { hour: i, minute: s };
            })(t.target.value);
            this._updateEditingEvent({ FIXED_HOUR: e.hour, FIXED_MINUTE: e.minute });
          }}
        />
      </div>
    `;
    ...
    return this._editingEvent
      ...
      <div class="form-group">
        ...
        <div class="weekday-checkboxes">
          ${St.map((t) => {
            const e = At[t],
              i = this._editingEvent.WEEKDAY.includes(e);
            return Y`
                ...
                <input
                  ...
                  @change=${(t) => {
                    const i = t.target.checked,
                      s = [...this._editingEvent.WEEKDAY];
                    if (i && !s.includes(e)) s.push(e);
                    else if (!i) {
                      const t = s.indexOf(e);
                      t > -1 && s.splice(t, 1);
                    }
                    this._updateEditingEvent({ WEEKDAY: s });
                  }}
                />
          ...
          "SWITCH" === this._category || "LOCK" === this._category
            ? Y`
              <select
                ...
                @change=${(t) => {
                  ...
                  this._updateEditingEvent({ LEVEL: e });
                }}
              >
            ...
            : Y`
              <input
                ...
                @input=${(t) => {
                  const e = parseInt(t.target.value, 10) / 100;
                  this._updateEditingEvent({ LEVEL: e });
                }}
              />
          ...
          ? Y`
            <div class="form-group">
              ...
              <input
                ...
                @input=${(t) => {
                  const e = parseInt(t.target.value, 10) / 100;
                  this._updateEditingEvent({ LEVEL_2: e });
                }}
              />
  ...
  _renderDurationFields() {
    return this._editingEvent
      ? "SWITCH" !== this._category && "LIGHT" !== this._category
        ? Y``
        : Y`
      <div class="form-group">
        ...
        <input
          ...
          @input=${(t) => {
            const e = parseInt(t.target.value, 10);
            this._updateEditingEvent({ DURATION_FACTOR: e });
          }}
        />
        <select
          ...
          @change=${(t) => {
            const e = parseInt(t.target.value, 10);
            this._updateEditingEvent({ DURATION_BASE: e });
          }}
        >
        ...
        <input
          ...
          @input=${(t) => {
            const e = t.target.value
              ...
              .filter((t) => !isNaN(t));
            this._updateEditingEvent({ TARGET_CHANNELS: e });
          }}
          placeholder="1, 2, 4, 8"
        />
      </div>
  ...
  render() {
    ...
    const t = this._config.name || this._getEntityName(this._activeEntityId || "");
    return Y`
      <ha-card>
